...
- (void)viewDidLoad
{
    ...
    for (int i=1;i<ABAddressBookGetPersonCount(addressBook);i++){     
        
        ABRecordRef personRef=CFArrayGetValueAtIndex(peopleMutable, i); 
        ...
        NSString *nss=[NSString stringWithFormat:@"%c", firstname];
        [mta addObject:nss];
    ...
    //////////
//    self.roleArray = [[NSArray alloc] initWithObjects:@"野蠻人", @"法師", @"弓箭手", @"盜賊", @"德魯伊", @"騎士", nil];
...
//    return cell;
    ...
    //設定欄位的內容與類型
    cell.textLabel.text = [self.roleArray objectAtIndex:indexPath.row];
